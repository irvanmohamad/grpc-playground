...
var greetpb_greet_pb = require('../greetpb/greet_pb.js');

function serialize_greet_GreetEveryoneRequest(arg) {
  if (!(arg instanceof greetpb_greet_pb.GreetEveryoneRequest)) {
...
function deserialize_greet_GreetEveryoneRequest(buffer_arg) {
  return greetpb_greet_pb.GreetEveryoneRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_greet_GreetEveryoneResponse(arg) {
  if (!(arg instanceof greetpb_greet_pb.GreetEveryoneResponse)) {
...
function deserialize_greet_GreetEveryoneResponse(buffer_arg) {
  return greetpb_greet_pb.GreetEveryoneResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_greet_GreetManyTimesRequest(arg) {
  if (!(arg instanceof greetpb_greet_pb.GreetManyTimesRequest)) {
...
function deserialize_greet_GreetManyTimesRequest(buffer_arg) {
  return greetpb_greet_pb.GreetManyTimesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_greet_GreetManyTimesResponse(arg) {
  if (!(arg instanceof greetpb_greet_pb.GreetManyTimesResponse)) {
...
function deserialize_greet_GreetManyTimesResponse(buffer_arg) {
  return greetpb_greet_pb.GreetManyTimesResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_greet_GreetRequest(arg) {
  if (!(arg instanceof greetpb_greet_pb.GreetRequest)) {
...
function deserialize_greet_GreetRequest(buffer_arg) {
  return greetpb_greet_pb.GreetRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_greet_GreetResponse(arg) {
  if (!(arg instanceof greetpb_greet_pb.GreetResponse)) {
...
function deserialize_greet_GreetResponse(buffer_arg) {
  return greetpb_greet_pb.GreetResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_greet_LongGreetRequest(arg) {
  if (!(arg instanceof greetpb_greet_pb.LongGreetRequest)) {
...
function deserialize_greet_LongGreetRequest(buffer_arg) {
  return greetpb_greet_pb.LongGreetRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_greet_LongGreetResponse(arg) {
  if (!(arg instanceof greetpb_greet_pb.LongGreetResponse)) {
...
function deserialize_greet_LongGreetResponse(buffer_arg) {
  return greetpb_greet_pb.LongGreetResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var GreetServiceService = exports.GreetServiceService = {
  ...
  greetManyTimesMethod: {
    path: '/greet.GreetService/GreetManyTimesMethod',
    requestStream: false,
    responseStream: true,
    requestType: greetpb_greet_pb.GreetManyTimesRequest,
    responseType: greetpb_greet_pb.GreetManyTimesResponse,
  ...
  greetEveryoneMethod: {
    path: '/greet.GreetService/GreetEveryoneMethod',
    requestStream: true,
    responseStream: true,
